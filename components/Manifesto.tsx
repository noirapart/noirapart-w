...
export default function Manifesto() {
  ...
  const upcomingProjects = [
    ...
    { id: 'proj-3', type: t('upcoming.p3.type'), title: t('upcoming.p3.title'), description: t('upcoming.p3.description'), date: t('upcoming.p3.date') },
  ]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            <p className="text-gallery/50 text-base md:text-lg leading-relaxed mb-10 font-light">
              {t('manifesto.body')}
            </p>
            <a
              href="#contact"
        ...
        {/* Upcoming Projects */}
        <div ref={projRef} className="mt-14 md:mt-24 pt-12 md:pt-16 border-t border-gallery/10">
          <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {upcomingProjects.map((proj, i) => (
              <motion.div
                ...
                className="group relative flex flex-col p-5 sm:p-7 rounded-2xl border border-gallery/8 bg-gallery/4 hover:bg-gallery/8 hover:border-gallery/15 transition-all duration-300"
              >
                ...
                <h4 className="text-lg font-medium text-gallery mb-3">
                  {proj.title}
                </h4>
                <p className="text-sm text-gallery/40 leading-relaxed font-light flex-1">
                  {proj.description}
                </p>
